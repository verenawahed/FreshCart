...
export default function Home() {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row md:space-x-6 items-start pt-10">
            <div className="w-full md:w-[70%] flex justify-center">
                <SimpleSlider />
            </div>
            <div className="w-full md:w-[30%] flex flex-col space-y-4 pt-10">
                <img src={img1} className="w-full h-40 object-cover rounded-lg shadow-lg" alt="Thumbnail 1" />
                <img src={img2} className="w-full h-40 object-cover rounded-lg shadow-lg" alt="Thumbnail 2" />
                </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6 pt-5">
